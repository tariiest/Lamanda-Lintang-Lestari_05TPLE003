...
> ##### Tip!
> The [starter page](http://tiny.cc/7b2tzz/themes/v3/starter.html) is a good place to start building your app if you'd like to start from scratch.
{: .quote-info .mt-0}
...
CV Maju Sejahtera.2 provides a set of options to apply to your main layout. Each one of these classes can be added to the body tag to get the desired goal.
...
<div class="wrapper">
  <!-- Preloader -->
  <div class="preloader">
    <img src="dist/img/logocv.jpeg" alt="logocv" height="60" width="60">
  </div>
</div>
```
...
CV Maju Sejahtera.2 provides a dark mode option. You can add in body tag:
...
CV Maju Sejahtera.2 provides a set of color variations to apply to your sidebar (light & dark) & navbar. You can combine any available color with these class prefixes:
