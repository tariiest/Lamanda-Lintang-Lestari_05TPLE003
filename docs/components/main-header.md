...
Top navbar example can be found in this [demo page](http://tiny.cc/7b2tzz/themes/dev/AdminLTE/pages/layout/top-nav.html). 


<nav class="navbar navbar-expand navbar-light navbar-white">
  <div class="container">
    <a href="index.html" class="navbar-brand">
      <img src="{{ '/assets/img/logocv.jpeg' | prepend: site.baseurl }}" alt="Logo CV" class="brand-image img-circle elevation-3"
           style="opacity: .8; max-height: 33px;">
      <span class="brand-text font-weight-light">CV Maju Sejahtera</span>
    </a>
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
...
<nav class="main-header navbar navbar-expand navbar-light navbar-white">
  <div class="container">
    <a href="index.html" class="navbar-brand">
      <img src="dist/img/logocv.jpeg" alt="Logo CV" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">CV Maju Sejahtera</span>
    </a>
    <!-- Left navbar links -->
